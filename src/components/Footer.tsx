          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+302106771540" className="text-white/80 hover:text-white transition-colors text-sm">
                  +30 210 677 1540
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-5 w-5 flex-shrink-0" />
                <a href="mailto:info@gynecology.gr" className="text-white/80 hover:text-white transition-colors text-sm">
                  info@gynecology.gr
                </a>
              </li>
            </ul>
