...
const translations: Record<Language, Record<string, string>> = {
  el: {
    ...
    "about.subtitle": "Μαιευτήρας – Γυναικολόγος, Εξειδικευμένος στην Υποβοηθούμενη Αναπαραγωγή και την Ενδοσκοπική Χειρουργική",
    "about.intro": "Με εκτεταμένη εμπειρία στη γυναικολογία, μαιευτική και υποβοηθούμενη αναπαραγωγή, αφιερώνομαι στην παροχή εξατομικευμένης φροντίδας υψηλής ποιότητας, συνδυάζοντας επιστημονική αριστεία με συμπόνια και σεβασμό.",
    "about.profile.name": "Δρ. Ελευθέριος Χειράκης",
    "about.profile.title": "Μαιευτήρας Γυναικολόγος",
    "about.profile.specialties": "Υποβοηθούμενη Αναπαραγωγή • Ενδοσκοπική Χειρουργική • Μαιευτική",
    "about.education.title": "Εκπαίδευση & Εξειδίκευση",
    "about.education.medical": "Ιατρική Σχολή - Universitatea de Medicina si Farmacie 'Grigore T. Popa', Ιάσιο, Ρουμανία",
    "about.education.msc": "MSc Υποβοηθούμενης Αναπαραγωγής - Port Royal, Παρίσι",
    "about.education.endoscopy": "Διπλώματα Ενδοσκόπησης Bachelor in Endoscopy - Level 1 & Level 2 (CICE)",
    "about.education.certificates": "Πιστοποιητικά συμμετοχής σε διεθνή συνέδρια μαιευτικής, γυναικολογίας και κολπικού laser",
    "about.experience.title": "Επαγγελματική Εμπειρία",
    "about.experience.current": "Σύμβουλος Ιατρός Υποβοηθούμενης Αναπαραγωγής και Μαιευτικής-Γυναικολογίας",
    "about.experience.greece": "Embryoland • ΡΕΑ • Τζάνειο • Διαμαντής • Euromedica • Ερρίκος Ντυνάν • Νοσοκομείο Αίγινας",
    "about.experience.france": "Προηγούμενη εμπειρία στη Γαλλία: Port Royal, Saint Joseph, Victor Dupuy, Tenon",
    "about.experience.focus": "Εξειδίκευση σε θεραπείες γονιμότητας, διαχείριση εγκυμοσυνών υψηλού κινδύνου και ελάχιστα επεμβατικές χειρουργικές τεχνικές",
    ...
    "about.approach.title": "Η Φιλοσοφία μου",
    "about.approach.text": "Πιστεύω στην εξατομικευμένη προσέγγιση κάθε ασθενούς, συνδυάζοντας την ιατρική που βασίζεται σε επιστημονικά δεδομένα με τη συμπόνια και την ανθρώπινη επικοινωνία. Κάθε ασθενής είναι μοναδική και η θεραπεία της πρέπει να αντικατοπτρίζει τις ιδιαίτερες ανάγκες και επιθυμίες της.",
    "about.certification.title": "Πιστοποιήσεις & Αναγνώριση",
    "about.certification.text": "Μέλος της Ελληνικής Εταιρείας Μαιευτικής και Γυναικολογίας",
    "about.experience.years": "Πάνω από 15 χρόνια εμπειρίας",
    "about.experience.years.text": "Εκτεταμένη εμπειρία σε όλες τις πτυχές της υγείας των γυναικών",
    "about.learning.title": "Συνεχής Εκπαίδευση",
    "about.learning.text": "Τακτική συμμετοχή σε διεθνή ιατρικά συνέδρια και προηγμένα σεμινάρια",
    "about.seo.title": "Δρ. Ελευθέριος Χειράκης - Μαιευτήρας Γυναικολόγος Πειραιάς Αίγινα",
    "about.seo.description": "Δρ. Ελευθέριος Χειράκης, Μαιευτήρας Γυναικολόγος εξειδικευμένος στην Υποβοηθούμενη Αναπαραγωγή, Εξωσωματική Γονιμοποίηση και Ενδοσκοπική Χειρουργική. Ιατρεία στον Πειραιά και Αίγινα.",
  ...
  en: {
    ...
    "about.subtitle": "Obstetrician–Gynecologist, Specialist in Assisted Reproduction and Endoscopic Surgery",
    "about.intro": "With extensive experience in gynecology, obstetrics and assisted reproduction, I am dedicated to providing personalized, high-quality care, combining scientific excellence with compassion and respect.",
    "about.profile.name": "Dr. Eleftherios Cheirakis",
    "about.profile.title": "Obstetrician Gynecologist",
    "about.profile.specialties": "Assisted Reproduction • Endoscopic Surgery • Obstetrics",
    "about.education.title": "Education & Training",
    "about.education.medical": "Medical School - Universitatea de Medicina si Farmacie 'Grigore T. Popa', Iasi, Romania",
    "about.education.msc": "MSc in Assisted Reproduction - Port Royal, Paris",
    "about.education.endoscopy": "Bachelor in Endoscopy Diplomas - Level 1 & Level 2 (CICE)",
    "about.education.certificates": "Certificates from international congresses in obstetrics, gynecology and vaginal laser",
    "about.experience.title": "Professional Experience",
    "about.experience.current": "Consultant in Assisted Reproduction and Obstetrics-Gynecology",
    "about.experience.greece": "Embryoland • REA • Tzaneio • Diamantis • Euromedica • Errikos Dunant • Aegina Hospital",
    "about.experience.france": "Previous experience in France: Port Royal, Saint Joseph, Victor Dupuy, Tenon",
    "about.experience.focus": "Specializing in fertility treatments, high-risk pregnancy management and minimally invasive surgical techniques",
    ...
    "about.approach.title": "My Philosophy",
    "about.approach.text": "I believe in a personalized approach to each patient, combining evidence-based medicine with compassion and human communication. Every patient is unique and their treatment should reflect their individual needs and wishes.",
    "about.certification.title": "Certifications & Recognition",
    "about.certification.text": "Member of the Hellenic Society of Obstetrics and Gynecology",
    "about.experience.years": "15+ Years Experience",
    "about.experience.years.text": "Extensive experience in all aspects of women's health",
    "about.learning.title": "Continuous Learning",
    "about.learning.text": "Regular participation in international medical conferences and advanced seminars",
    "about.seo.title": "Dr. Eleftherios Cheirakis - Obstetrician Gynecologist Piraeus Aegina",
    "about.seo.description": "Dr. Eleftherios Cheirakis, Obstetrician Gynecologist specialized in Assisted Reproduction, IVF and Endoscopic Surgery. Clinics in Piraeus and Aegina, Greece.",
  ...
  fr: {
    ...
    "about.subtitle": "Gynécologue-obstétricien, spécialiste en reproduction assistée et chirurgie endoscopique",
    "about.intro": "Avec une vaste expérience en gynécologie, obstétrique et reproduction assistée, je me consacre à fournir des soins personnalisés de haute qualité, combinant l'excellence scientifique avec compassion et respect.",
    "about.profile.name": "Dr Eleftherios Cheirakis",
    "about.profile.title": "Gynécologue-obstétricien",
    "about.profile.specialties": "Reproduction Assistée • Chirurgie Endoscopique • Obstétrique",
    "about.education.title": "Formation & Diplômes",
    "about.education.medical": "Faculté de Médecine - Universitatea de Medicina si Farmacie 'Grigore T. Popa', Iasi, Roumanie",
    "about.education.msc": "MSc en Reproduction Assistée - Port Royal, Paris",
    "about.education.endoscopy": "Diplômes Bachelor in Endoscopy - Level 1 & Level 2 (CICE)",
    "about.education.certificates": "Certificats de participation à des congrès internationaux en obstétrique, gynécologie et laser vaginal",
    "about.experience.title": "Expérience Professionnelle",
    "about.experience.current": "Médecin consultant en Reproduction Assistée et Gynécologie-Obstétrique",
    "about.experience.greece": "Embryoland • REA • Tzaneio • Diamantis • Euromedica • Errikos Dunant • Hôpital d'Égine",
    "about.experience.france": "Expérience antérieure en France : Port Royal, Saint Joseph, Victor Dupuy, Tenon",
    "about.experience.focus": "Spécialisé dans les traitements de fertilité, la gestion des grossesses à haut risque et les techniques chirurgicales mini-invasives",
    "about.languages.title": "Langues",
    "about.languages.greek": "Grec (Maternel)",
    "about.languages.english": "Anglais (C2)",
    "about.languages.french": "Français (C1)",
    "about.languages.romanian": "Roumain (B2)",
    "about.approach.title": "Ma Vision du Soin",
    "about.approach.text": "Je crois en une approche personnalisée de chaque patiente, combinant une médecine basée sur des preuves scientifiques avec compassion et communication humaine. Chaque patiente est unique et son traitement doit refléter ses besoins et souhaits individuels.",
    "about.certification.title": "Certifications & Reconnaissance",
    "about.certification.text": "Membre de la Société Hellénique d'Obstétrique et de Gynécologie",
    "about.experience.years": "Plus de 15 ans d'expérience",
    "about.experience.years.text": "Vaste expérience dans tous les aspects de la santé des femmes",
    "about.learning.title": "Formation Continue",
    "about.learning.text": "Participation régulière à des congrès médicaux internationaux et séminaires avancés",
    "about.seo.title": "Dr Eleftherios Cheirakis - Gynécologue-obstétricien Pirée Égine",
    "about.seo.description": "Dr Eleftherios Cheirakis, gynécologue-obstétricien spécialisé en Reproduction Assistée, FIV et Chirurgie Endoscopique. Cliniques au Pirée et à Égine, Grèce.",
