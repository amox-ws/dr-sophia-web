...
const translations: Record<Language, Record<string, string>> = {
  el: {
    ...
    'services.gynecology.endometriosis.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για την ενδομητρίωση.',
    'services.gynecology.adenomyosis.title': 'Αδενομύωση',
    'services.gynecology.adenomyosis.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για την αδενομύωση.',
    'services.gynecology.deepEndometriosis.title': 'Εν τω βάθει ενδομητρίωση',
    'services.gynecology.deepEndometriosis.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για την εν τω βάθει ενδομητρίωση.',
    'services.gynecology.endometrioma.title': 'Ενδομητρίωμα – Κύστες Ενδομητρίωσης',
    'services.gynecology.endometrioma.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για το ενδομητρίωμα.',
    'services.gynecology.uterineFibroids.title': 'Ινομυώματα μήτρας',
    'services.gynecology.uterineFibroids.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για τα ινομυώματα μήτρας.',
    'services.gynecology.polycysticOvaries.title': 'Πολυκυστικές ωοθήκες',
    'services.gynecology.polycysticOvaries.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για τις πολυκυστικές ωοθήκες.',
    ...
    'services.assistedReproduction.fertilityInvestigation.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για τη διερεύνηση γονιμότητας.',
    'services.assistedReproduction.maleInfertility.title': 'Α. Ανδρικός παράγοντας υπογονιμότητας',
    'services.assistedReproduction.maleInfertility.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για τον ανδρικό παράγοντα.',
    'services.assistedReproduction.femaleInfertility.title': 'Β. Γυναικείος παράγοντας υπογονιμότητας',
    'services.assistedReproduction.femaleInfertility.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για τον γυναικείο παράγοντα.',
    'services.assistedReproduction.eggFreezing.title': 'Κρυοσυντήρηση ωαρίων',
    'services.assistedReproduction.eggFreezing.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για την κρυοσυντήρηση ωαρίων.',
    'services.assistedReproduction.ivf.title': 'Εξωσωματική γονιμοποίηση',
    'services.assistedReproduction.ivf.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για την εξωσωματική γονιμοποίηση.',
    ...
    'services.assistedReproduction.iui.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για την ενδομητρική σπερματέγχυση.',
    'services.assistedReproduction.pgt.title': 'Προεμφυτευτικός έλεγχος',
    'services.assistedReproduction.pgt.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για τον προεμφυτευτικό έλεγχο.',
    'services.assistedReproduction.donorEggsSperm.title': 'Δωρεά ωαρίων και σπέρματος',
    'services.assistedReproduction.donorEggsSperm.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για τη δωρεά γαμετών.',
    'services.assistedReproduction.surrogacy.title': 'Παρένθετη μητρότητα',
    'services.assistedReproduction.surrogacy.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για την παρένθετη μητρότητα.',
    ...
    'services.endoscopicSurgery.hysteroscopy.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για την υστεροσκόπηση.',
    ...
    'services.endoscopicSurgery.roboticSurgery.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για τη ρομποτική χειρουργική.',
    ...
    'services.pregnancy.prenatalScreening.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για τον προγεννητικό έλεγχο.',
    ...
    'services.pregnancy.ultrasound3d4d.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για το υπερηχογράφημα 3D-4D.',
    ...
    'services.pregnancy.vbac.description': 'Εδώ θα προστεθεί λεπτομερής περιγραφή για τον φυσιολογικό τοκετό μετά από καισαρική.',
  ...
  en: {
    ...
    'services.gynecology.deepEndometriosis.description': 'Detailed description for deep endometriosis will be added here.',
    ...
    'services.gynecology.polycysticOvaries.description': 'Detailed description for polycystic ovaries will be added here.',
    ...
    'services.assistedReproduction.fertilityInvestigation.description': 'Detailed description for fertility investigation will be added here.',
    'services.assistedReproduction.maleInfertility.title': 'A. Male Infertility Factor',
    'services.assistedReproduction.maleInfertility.description': 'Detailed description for male infertility will be added here.',
    'services.assistedReproduction.femaleInfertility.title': 'B. Female Infertility Factor',
    'services.assistedReproduction.femaleInfertility.description': 'Detailed description for female infertility will be added here.',
    'services.assistedReproduction.eggFreezing.title': 'Egg Freezing',
    'services.assistedReproduction.eggFreezing.description': 'Detailed description for egg freezing will be added here.',
    ...
    'services.assistedReproduction.donorEggsSperm.description': 'Detailed description for donor eggs & sperm will be added here.',
    ...
    'services.endoscopicSurgery.roboticSurgery.description': 'Detailed description for robotic surgery will be added here.',
    ...
    'services.pregnancy.prenatalScreening.description': 'Detailed description for prenatal screening will be added here.',
  ...
  fr: {
    ...
    'services.gynecology.deepEndometriosis.description': 'Une description détaillée pour l\'endométriose profonde sera ajoutée ici.',
    ...
    'services.gynecology.uterineFibroids.description': 'Une description détaillée pour les fibromes utérins sera ajoutée ici.',
    'services.gynecology.polycysticOvaries.title': 'Ovaires polykystiques',
    'services.gynecology.polycysticOvaries.description': 'Une description détaillée pour les ovaires polykystiques sera ajoutée ici.',
    ...
    'services.assistedReproduction.fertilityInvestigation.description': 'Une description détaillée pour le bilan de fertilité sera ajoutée ici.',
    'services.assistedReproduction.maleInfertility.title': 'A. Facteur masculin',
    'services.assistedReproduction.maleInfertility.description': 'Une description détaillée pour le facteur masculin sera ajoutée ici.',
    'services.assistedReproduction.femaleInfertility.title': 'B. Facteur féminin',
    'services.assistedReproduction.femaleInfertility.description': 'Une description détaillée pour le facteur féminin sera ajoutée ici.',
    'services.assistedReproduction.eggFreezing.title': 'Congélation ovocytaire',
    'services.assistedReproduction.eggFreezing.description': 'Une description détaillée pour la congélation ovocytaire sera ajoutée ici.',
    ...
    'services.assistedReproduction.iui.description': 'Une description détaillée pour l\'insémination intra-utérine sera ajoutée ici.',
    'services.assistedReproduction.pgt.title': 'Diagnostic pré-implantatoire',
    'services.assistedReproduction.pgt.description': 'Une description détaillée pour le diagnostic pré-implantatoire sera ajoutée ici.',
    'services.assistedReproduction.donorEggsSperm.title': 'Don d\'ovocytes et de sperme',
    'services.assistedReproduction.donorEggsSperm.description': 'Une description détaillée pour le don de gamètes sera ajoutée ici.',
    'services.assistedReproduction.surrogacy.title': 'Gestation pour autrui',
    'services.assistedReproduction.surrogacy.description': 'Une description détaillée pour la gestation pour autrui sera ajoutée ici.',
    ...
    'services.endoscopicSurgery.hysteroscopy.description': 'Une description détaillée pour l\'hystéroscopie sera ajoutée ici.',
    'services.endoscopicSurgery.laparoscopy.title': 'Laparoscopie',
    'services.endoscopicSurgery.laparoscopy.description': 'Une description détaillée pour la laparoscopie sera ajoutée ici.',
    'services.endoscopicSurgery.roboticSurgery.title': 'Chirurgie robotique',
    'services.endoscopicSurgery.roboticSurgery.description': 'Une description détaillée pour la chirurgie robotique sera ajoutée ici.',
    ...
    'services.pregnancy.prenatalScreening.description': 'Une description détaillée pour le dépistage prénatal sera ajoutée ici.',
    ...
    'services.pregnancy.ultrasound3d4d.description': 'Une description détaillée pour l\'échographie 3D-4D sera ajoutée ici.',
    ...
    'services.pregnancy.twinPregnancy.description': 'Une description détaillée pour la grossesse gémellaire sera ajoutée ici.',
